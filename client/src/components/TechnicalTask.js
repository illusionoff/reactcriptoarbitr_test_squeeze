    ...
    <>
      ...
      <div >
        <div className="container">
          ...
          Исследование возможностей извлечения прибыли на разнице курсов между двумя криптобиржами (межбиржевой арбитраж).<p>При успешном выполнении всех требований, перечисленных ниже, разработка нового проекта прототипа на основе данных исследований.</p>
          ...
          <ul className="browser-default">
            ...
            <li>Использование API криптобирж  (далее бирж) для получения данных котировок в реальном времени, максимально быстро. Анализ производительности проекта на тестовом сервере</li>
            ...
            <li>Загрузка файлов статистики .CSV работающего проекта</li>
            <li>Визуализация данных из файлов статистики .CSV в виде графиков</li>
          </ul>
        </div >
      </div>
    </>
