  ...
  return (
    <>
      ...
      <div className="container">
        ...
        В общем итоге исследование поставленных целей по экономическим показателям. Однако по техническим показателям, например, как  производительность системы, надежность системы оказалась приемлемой.
      </div >
    </>
  )
}
