    ...
    <>
      ...
      <div className="container">
        ...
        <ul className="browser-default">
          ...
          <li>Время сбора данных с 7 сентября до 27 октября 2021 г.</li>
        </ul>

        <h5><p>Результаты работы по критериям оценки</p></h5>
        <ul className="browser-default">
          <li><strong>1,2</strong> Время сбора данных с 7 сентября до 27 октября 2021 г. Максимальный процент прибыльной сделки составил 4.85% 14 октября 2021 г. в это время цены sell и buy на бирже Bithamp Global не менялись около 14.5 секунд (время “коридора”)</li>
          ...
          <li><strong>5.</strong> Средний пинг между серверами оказался около 119 мс. Итого умножаем на 3, получаем 357 мс - минимальное время “коридора”</li>
        </ul>
        <blockquote>
